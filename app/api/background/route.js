...
export async function POST(req) {
  try {
    ...
    const seed = body.seed; // Background type for gen_background (e.g., "arachnophobia" or "hematophobia")
    ...
    // Step 2: Apply the Gen Background transformation
    const transformedUrl = cloudinary.url(publicId, {
      transformation: [
        {
          effect: `gen_background_replace:${backgroundType};seed_${seed}`,
        },
      ],
    });
